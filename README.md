...
| 0049 | [Group Anagrams](https://leetcode.com/problems/group-anagrams/)                             |        [cc](cpp/hash-table/49.group-anagrams.cc)         |        [java](java/hash-table/49.group-anagrams.java)         |   Medium   | `Array` `Hash Table` `String` `Sorting` |
| 0128 | [Longest Consecutive Sequence](https://leetcode.com/problems/longest-consecutive-sequence/) | [cc](cpp/hash-table/128.longest-consecutive-sequence.cc) | [java](java/hash-table/128.longest-consecutive-sequence.java) |   Medium   |    `Array` `Hash Table` `Union Find`    |
| 0217 | [Contains Duplicate](https://leetcode.com/problems/contains-duplicate/)                     |      [cc](cpp/hash-table/217.contains-duplicate.cc)      |      [java](java/hash-table/217.contains-duplicate.java)      |    Easy    |     `Array` `Hash Table` `Sorting`      |
| 0238 | [Product of Array Except Self](https://leetcode.com/problems/product-of-array-except-self/) |   [cc](cpp/array/238.product-of-array-except-self.cc)    |   [java](java/array/238.product-of-array-except-self.java)    |   Medium   |          `Array` `Prefix Sum`           |
